...
public class MediaUploadService {
    ...
    public ResponseResult sendProcessVideoMsg(String mediaFileId) {
        //查询数据库mediaFile
        Optional<MediaFile> optional = mediaFileRepository.findById(mediaFileId);
        //判断是否获取成功
        ...
        map.put("mediaId", mediaFileId);
        String jsonString = JSON.toJSONString(map);
        //向MQ发送视频处理消息  参数为交换机名称 rountingkey   参数
